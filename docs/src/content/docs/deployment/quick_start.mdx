...
```
Afterwards, app should be accessible at http://127.0.0.1:8080.
:::

:::tip[Not owning a Kubernetes cluster?]
Checkout docker [deployment method](/deployment/deploy_docker) and it's [limitations](/about/features).
:::